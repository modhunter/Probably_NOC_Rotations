...
local combat = {
	...
	{{
		...
		{ "Tiger Palm", "player.spell(Keg Smash).cooldown > 0.5" },
...
ProbablyEngine.rotation.register_custom(268, "|cFF32ff84NOC Brewmaster Monk 6.0 (alternate)|r", combat, ooc, onLoad)
